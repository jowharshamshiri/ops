...
mod tests {
    ...
    // TEST0091: Use the op! macro to generate a thumbnail op and verify it processes the file and updates context
    #[tokio::test]
    async fn test0091_generate_thumbnail_macro() {
    ...
    // TEST0092: Use the op! macro to generate a file processing op and verify context updates and result string
    #[tokio::test]
    async fn test0092_process_file_macro() {
        let mut ctx = OpContext::new();
