...
mod tests {
    ...
    // TEST0057: Invoke the abort macro without a reason and verify the context is aborted with no reason string
    #[tokio::test]
    ...
    // TEST0058: Invoke the abort macro with a reason string and verify abort_reason matches
    #[tokio::test]
    ...
    // TEST0059: Use the continue_loop macro inside an op and verify the scoped continue flag is set in context
    #[tokio::test]
    ...
    // TEST0060: Use check_abort macro to short-circuit when the abort flag is already set in context
    #[tokio::test]
